						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item m-nav__item--home">
										<a href="admin/staff" class="m-nav__link">
											<span class="m-nav__link-text">Daftar staff</span>									
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="m-portlet__body">
								<div class="tab-content">
									<div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
										<form class="m-form m-form--fit m-form--label-align-right" id="tambahStaff">                                            
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Nama klinik</label>
												<div class="col-xl-10 col-lg-10">
													<select class="form-control m-select2" name="id_klinik" id="klinik" style="width:100%;">
														<option></option>
														<?php
															foreach($klinik as $row)
															{
																make('option', $row['nama_klinik'], 'value::'.$row['id_klinik']);
															}
														?>
													</select>
													<div class="m--font-danger ml_input_eh set_error" id="id_klinik"></div>
												</div>
											</div>

											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Nama staff</label>
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="nama_staff" placeholder="nama staff">
													<div class="m--font-danger ml_input_eh set_error" id="nama_staff"></div>
												</div>
											</div>
