							...
							<div class="m-portlet__body">
								<div class="tab-content">
									<div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
										<form class="m-form m-form--fit m-form--label-align-right" id="tambahKlinik">
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Nama klinik</label>
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="nama_klinik" placeholder="nama klinik">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="text" autocomplete="off" name="lokasi_klinik" placeholder="lokasi klinik">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="number" autocomplete="off" name="telpon" placeholder="nomor telpon">
