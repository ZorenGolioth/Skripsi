												...
												<tbody>
													...
													foreach($staff_klinik as $row)
													{
														...
														<tr>
															...
															<td>
																<a href="admin/delete-staff/<?php echo $id_user; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill">
