                                            ...
                                            <li class="m-menu__item">
                                                ...
                                                <ul class="m-menu__inner">
                                                    <li class="m-menu__item" m-menu-link-redirect="1" aria-haspopup="true">
                                                        <a href="admin/tambah-klinik" class="m-menu__link">
                                                            <i class="m-menu__link-icon fa fa-plus"></i>
                                                            <span class="m-menu__link-text">Tambah klinik</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-menu__item" m-menu-link-redirect="1" aria-haspopup="true">
                                                        <a href="admin/tambah-dokter" class="m-menu__link">
                                                            <i class="m-menu__link-icon fa fa-plus"></i>
                                                            <span class="m-menu__link-text">Tambah dokter</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-menu__item" m-menu-link-redirect="1" aria-haspopup="true">
                                                        <a href="admin/tambah-staff" class="m-menu__link">
                                                            <i class="m-menu__link-icon fa fa-plus"></i>
                                                            <span class="m-menu__link-text">Tambah staff</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
